...
3.1.	Clone or download the project repository from GitHub.
3.2.	Open a terminal and navigate to the project directory.
3.3.	Run the following command to install the required libraries:
...
4.1.	Enter the Product Name in the designated input field.
4.2.	Choose the E-commerce Site from the dropdown menu (e.g., Amazon, Flipkart).
4.3.	Click the Analyse button to retrieve product data.
4.4.	The tool will display detailed product information, including ratings, reviews, and other relevant data.

5.	Code Structure

The project code is structured as follows:
5.1. scraper_flipkart.py:
...
6.	Data Export: The tool allows users to export the retrieved data to formats like CSV or Excel for further analysis or reporting.
